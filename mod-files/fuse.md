...
features:
  ...
  cards:
    - enabled: true
      icon: <i class="fa-solid fa-shield-halved"></i> # Use fontawesome icons only found here https://fontawesome.com/search?ic=free-collection
    ...
    - enabled: true
      icon: <i class="fa-solid fa-gear"></i> # Use fontawesome icons only found here https://fontawesome.com/search?ic=free-collection
      name: Set It Up Once
    ...
    - enabled: true
      icon: <i class="fa-solid fa-code"></i> # Use fontawesome icons only found here https://fontawesome.com/search?ic=free-collection
    ...
    - enabled: true
      icon: <i class="fa-solid fa-share-nodes"></i> # Use fontawesome icons only found here https://fontawesome.com/search?ic=free-collection
